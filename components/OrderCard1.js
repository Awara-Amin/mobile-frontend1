...
const OrderCard = (props) => {
  ...
  const deleteOrder = (id) => {
    ...
    axios
      .delete(`${baseURL}orders/${props.id}`, config)
      .then((res) => {
  ...
  useEffect(() => {
    socket.off("updateOrderBySocket").on("updateOrderBySocket", (data) => {
      ...
      setPropedOrder(newEdit);
      // console.log("test-1TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT-16000");
      // console.log(propedOrder);
