...
const TabBarScreen = (props) => {
  ...
  // console.log(props);
  // console.log("inside TabBarScreen 1112 kaka aaaaaaaaaaaaaaaaa");
  //bq
  ...
  // console.log("propedCartItem check 1113 kaka");
  ...
  useEffect(() => {
    ...
    // bq
    setPropedCartItem(props.cartItems.cartItems);
    // setPropedCartItem(props.cartItems);
  ...
  }, [props, propedCartItem, forRendering]);
  // console.log("forRendering 31 out kakaaaaaaaaaa RR");
  // console.log(forRendering);
  // console.log(propedCartItem);
        ...
        <View style={{ justifyContent: "center", marginTop: 15.0 }}>
          ...
          <View style={styles.bookContainerStyle}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                // alert("hi kaka");
                [props.removeFromCart(item), setForRendering(true)];
              }}
              // onPress={() =>
              //   navigation.navigate("TimeSlots", {
              //     image: item.image,
...
export default connect(mapStateToProps, mapToDispatchToProps)(TabBarScreen);
