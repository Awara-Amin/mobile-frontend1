...
const ProductFormScreen = (props) => {
  console.log("props ssssssssssssssssssssss 101");
  console.log(props);
  // console.log(props.route.params.item);
  // console.log(props.route.params.item._id);
  console.log("props ssssssssssssssssssssss 102");
  // console.log(props.route.params.item.category.name);
  ...
  //     quality: 1,
  //   });
  //   console.log("result 11 wwwwwwwwwwwwwwwwwwwwwww t1");
  //   console.log(result);

  //   if (!result.canceled) {
  //     // console.log("result 11 wwwwwwwwwwwwwwwwwwwwwww 22");
  //     // console.log(result);

  //     setMainImage(result.uri); //this becomes image on the mobile screen
  //     setImage(result.uri); // this is sent by URL to the server and it saved there
          ...
          .then((res) => {
            ...
            if (res.status == 200 || res.status == 201) {
              ...
              setTimeout(() => {
                ...
                props.navigation.navigate("ProductMainScreen");
              }, 500);
            }
          })
          .catch((error) => {
