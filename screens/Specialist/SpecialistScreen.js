...
// const SpecialistScreen = ({ navigation, route, props }) => {
const SpecialistScreen = (props) => {
  // const type = route.params.name;
  // const productType = route.params.name1;
  // console.log("res.data kakaaaaaaa aaaaaaaaaaaaaaaaaaaaaaaaaa1555");
  // console.log(props.route.params.name1);
  // const categoryName = props.route.params.name;

  const [categoryName, setCategoryName] = useState(props.route.params.name);
  ...
  //       .then((res) => {
  //         console.log("res.data kakaaaaaaa aaaaaaaaaaaaaaaaaaaaaaaaaa1333");
  ...
  // console.log("res.data kakaaaaaaa aaaaaaaaaaaaaaaaaaaaaaaaaa1666");
  // console.log(categoryName);

  useEffect(() => {
    // console.log("res.data kakaaaaaaa aaaaaaaaaaaaaaaaaaaaaaaaaa1888");
    // changeCtg();

    axios
      .get(`${baseURL}products`)
      .then((res) => {
        // console.log("res.data kakaaaaaaa aaaaaaaaaaaaaaaaaaaaaaaaaa1111");
        // console.log(res.data);
        // console.log("res.data kakaaaaaaa aaaaaaaaaaaaaaaaaaaaaaaaaa1222");
  ...
  const changeCtg = () => {
    console.log("res.data kakaaaaaaa aaaaaaaaaaaaaaaaaaaaaaaaaa ESTA");
    console.log(categoryName);

    setProductsCtg(
      products.filter((i) => i.category._id == categoryName),
      setActive(true)
    );

    // console.log("res.data kakaaaaaaa aaaaaaaaaaaaaaaaaaaaaaaaaa ESTA-2");
    // console.log(productsCtg);
  };
  // console.log("res.data kakaaaaaaa aaaaaaaaaaaaaaaaaaaaaaaaaa177711");
  // console.log(productsCtg);
  // console.log("res.data kakaaaaaaa aaaaaaaaaaaaaaaaaaaaaaaaaa199991");
  // console.log(productsCtg.category);
  return (
    <SafeAreaView
      style={{ flex: 1 }}
